...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold float-right text-primary"><span>@yield('title')</span></h6>
        </div>
        <div class="card-body">
            <form action="{{route('admin.config.update')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Sitenin Durumu</label>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-block btn-md btn-info">Güncelle</button>
                </div>
            </form>
        </div>
    </div>
